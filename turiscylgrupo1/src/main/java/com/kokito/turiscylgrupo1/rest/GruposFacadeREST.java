...
public class GruposFacadeREST extends AbstractFacade<Grupos> {
    ...
    @PersistenceContext(unitName = "com.kokito_turiscylgrupo1_war_1.0-SNAPSHOTPU")
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") String id, Grupos entity) {
        super.edit(entity);
    }
    ...
    public Grupos find(@PathParam("id") String id) {
